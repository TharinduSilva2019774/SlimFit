...
function EditSettingScreen() {
  ...
  const fetchUserData = async () => {
    ...
    setHight(json.height);
    setWeight(json.weight);
    setWeeklyWeightLossGoal(json.weeklyWeightLossGoal);
    setDailyActivityGoal(json.dailyActivityGoal);
    setTargetWeight(json.targetWeight);
    setGender(json.gender);
    setDob(new Date(json.dateOfBirth));
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.headerContainer}>
        <Text style={styles.headerText}>Edit Your Profile Information</Text>
      </View>
      <View style={styles.inputField}>
        ...
        <View style={styles.profileAttributeContainer}>
          ...
          <TextInput
            ...
            placeholder={"..."}
            placeholderTextColor="#FFF"
            value={weeklyWeightLossGoal.toLocaleString()}
            keyboardType="numeric"
          />
        ...
        <View style={styles.profileAttributeContainer}>
          ...
          <TextInput
            ...
            placeholder={"..."}
            placeholderTextColor="#FFF"
            value={dailyActivityGoal.toLocaleString()}
            keyboardType="numeric"
          />
        </View>
        <View style={styles.profileAttributeContainer}>
          ...
          <TextInput
            ...
            placeholder={"..."}
            placeholderTextColor="#FFF"
            value={targetWeight.toLocaleString()}
            keyboardType="numeric"
          />
          <Text style={{ color: "red", paddingTop: "4%" }}>
            {targetWeight < 40 &&
